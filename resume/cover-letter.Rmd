...
Your open position for a [Customer Success Representative](https://hire.withgoogle.com/public/jobs/rstudiocom/view/P_AAAAAACAAJZPJ1EPP3oDOq) seems like an excellent opportunity for me to contribute to the growth of RStudio. Please consider my application.

I know what success with RStoduio looks like. RStudio's IDE, packages, and learning resources have helped me grow as a data scientist since 2013. RStudio has also supported me, and the Latin American community I represent, via a diversity scholarship to attend rstudio::conf() 2019. Now I am eager to multiply the effect, and I seem to have the skills you need for this positoin:





My experience in sales and dealing with customers, teaching, 
...
. In this unique role, you will be responsible for growing revenue by educating customers about the array of benefits from our toolchain, many of which are new, evolving, and not necessarily well-known. As a trusted and responsive partner, you will help customers maximize the impact of their data science initiatives through the adoption, continuation, and expansion of RStudio products. At the same time, you will share valuable customer and end-user insights with engineering and data science colleagues to further evolve RStudio products and packages.
...
ixpantia, jim hester, jeff allen, jenny
nominee Kelly
